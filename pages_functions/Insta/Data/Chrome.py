...
class Chrom_Insta:
    ...
    def switch(self,email,password,cook,pas):
        bot = self.bot
    ...
    def Edit_Bio(self,bio):
        try:
            ...
            sleep(2)
            try:
                WebDriverWait(self.bot, 10).until(EC.element_to_be_clickable((By.CSS_SELECTOR, 'textarea[id="pepBio"]'))).click();pyautogui.write(bio.strip())
                sleep(1)
