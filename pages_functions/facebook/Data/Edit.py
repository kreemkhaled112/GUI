...
class Edit_Photo:
    ...
    def Edit_Photo(self):
        try:           
            ...
            if cek == 'Your account is restricted at this time' or cek == 'You are Temporarily Blocked' or cek == 'Error' :
                print(Colorate.Diagonal(Colors.red_to_blue, f'[ Failed to Change Profile Photo ]', 1))
                return "failed"
            else:
                print(Colorate.Diagonal(Colors.green_to_cyan, f'[ Successfully Changed Profile Photo ]', 1))
                return "successfully"
...
class Edit_Cover:
    ...
    def Edit_Cover(self,):
        try:
            ...
            cek = pos.find('title').text
            if cek == 'Your account is restricted at this time' or cek == 'You are Temporarily Blocked' or cek == 'Error' :
                print(Colorate.Diagonal(Colors.red_to_blue, f'[ Failed to Change Cover Photo ] : [{self.photo}]', 1))
                return "failed"
            else:
                print(Colorate.Diagonal(Colors.green_to_cyan, f'[ Successfully Change Cover Photo ]', 1))
                return "successfully"
        except Exception as e:
            print(Colorate.Diagonal(Colors.yellow_to_red, f'[ Failed to Change Cover Photo ] : [{self.photo}]', 1))
            return "failed"
class Edit_bio:
    ...
    def update_bio(self):
        try:
            ...
            cek = pos.find('title').text
            if cek == 'Your account is restricted at this time' or cek == 'You are Temporarily Blocked' or cek == 'Error' :
                print(Colorate.Diagonal(Colors.red_to_blue, f'[ Failed to Change Bio ]', 1))
            else:
                print(Colorate.Diagonal(Colors.green_to_cyan, f'[ Successfully Change Bio ]', 1))
        except Exception as e:
            print(Colorate.Diagonal(Colors.red_to_blue, f'[ Failed to Change Bio ]', 1))
class Edit_City:
    ...
    def scrap(self):
        try:
            ...
            cek = pos.find('title').text
            if cek == 'Your account is restricted at this time' or cek == 'You are Temporarily Blocked' or cek == 'Error' :
                print(Colorate.Diagonal(Colors.red_to_blue, f'[ Failed to Change City ]', 1))
            else:
                print(Colorate.Diagonal(Colors.green_to_cyan, f'[ Successfully Change City ]', 1))
...
class lock_profile:
    ...
    def execute(self,stat):
        try:
            ...
            if str(pos['data']['toggle_wem_private_sharing_control_enabled']) == 'None': print('Locked Profile Not Available!')
            elif str(pos['data']['toggle_wem_private_sharing_control_enabled']['private_sharing_enabled']) == 'True': print(Colorate.Diagonal(Colors.green_to_cyan, f'[ Successfully Activating the Locked Profile ! ]', 1))
            elif str(pos['data']['toggle_wem_private_sharing_control_enabled']['private_sharing_enabled']) == 'False': print('Successfully Deactivated the Locked Profile !')
            else: print(pos)
        except Exception as e:
            print(e)
