...
with open("account.txt", "w",encoding="UTF-8") as file:
     for line in lines:
          if line.strip() and "علي سمير," not in line:
...
# cooki = 'c_user=100095787271866;datr=1jbUZNqFWpo72V3sG0Dz8SOU;sb=1jbUZHtIhC6Mh_0SrgpLIfft;wd=1920x919;m_page_voice=100095787271866;ps_n=1;ps_l=1;xs=25%3A2c74wdKMzOaLDw%3A2%3A1691629295%3A-1%3A-1%3A%3AAcVgD1wxvMYAsUp6ctgrhqte4jXHwgFUp6UaY2FXUw;fr=1x63AxBuZuOFAON9R.AWUsIEE6x_yKYBa1dC2wVkZ6rns.BmibvB..AAA.0.0.BmibvB.AWVYU3w4axQ;presence=C%7B%22t3%22%3A%5B%5D%2C%22utc3%22%3A1720302857649%2C%22v%22%3A1%7D;'
# result = Like_Page('https://www.facebook.com/profile.php?id=100091859916513',cooki).Start()
# print(result)
