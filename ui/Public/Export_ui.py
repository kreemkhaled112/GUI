# Form implementation generated from reading ui file 'p:\API\GUI\ui\Public\Export.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.Group = QtWidgets.QCheckBox(parent=self.widget_5)
        self.Group.setObjectName("Group")
        self.horizontalLayout_2.addWidget(self.Group)
        self.UserName = QtWidgets.QCheckBox(parent=self.widget_5)
        self.UserName.setObjectName("UserName")
        self.horizontalLayout_2.addWidget(self.UserName)
        self.Email = QtWidgets.QCheckBox(parent=self.widget_5)
        self.Email.setObjectName("Email")
        self.horizontalLayout_2.addWidget(self.Email)
        self.Password = QtWidgets.QCheckBox(parent=self.widget_5)
        self.Password.setObjectName("Password")
        self.horizontalLayout_2.addWidget(self.Password)
        self.Cookie = QtWidgets.QCheckBox(parent=self.widget_5)
        self.Cookie.setObjectName("Cookie")
        self.horizontalLayout_2.addWidget(self.Cookie)
        self.Type = QtWidgets.QCheckBox(parent=self.widget_5)
        self.Type.setObjectName("Type")
        self.horizontalLayout_2.addWidget(self.Type)
        self.verticalLayout_3.addWidget(self.widget_5, 0, QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.verticalLayout.addWidget(self.label_2, 0, QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.verticalLayout_2.addWidget(self.widget_4, 0, QtCore.Qt.AlignmentFlag.AlignTop)
        self.checkBox = QtWidgets.QCheckBox(parent=self.widget)
        self.checkBox.setText("")
        self.checkBox.setObjectName("checkBox")
        self.verticalLayout_2.addWidget(self.checkBox, 0, QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.Export = QtWidgets.QPushButton(parent=self.widget_7)
        ...
        self.verticalLayout_3.addWidget(self.widget_7, 0, QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignBottom)
